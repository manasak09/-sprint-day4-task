...
function UpdateInjuries(props){
 ...
 return (<><div style={{left:300,position:"relative",top:-500}}>
    ...
    <span style = {{ color: 'red' }}> {iderror} </span><br/>
     ...
     }/>   <Avatar sx={{ bgcolor: green[500] ,left:140,top:-33}} variant="rounded">
     <AddBoxIcon/>
   </Avatar>
      <br/>
     <input type='button' style={{color:'black',backgroundColor:'#00C9A7',height:30,width:60}}value ='Delete' onClick={()=>{
      ...
      <Avatar sx={{ bgcolor: green[500] ,left:80,top:-33}} variant="rounded">
    <DeleteSweepIcon/>
   </Avatar><br/>
